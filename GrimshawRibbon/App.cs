...
namespace GrimshawRibbon
{
    class App : IExternalApplication
    {
        ...
        static void AddRibbonPanel(UIControlledApplication application)
        {
            ...
            // create push button for PurgeCADImport
            PushButtonData b1Data = new PushButtonData(
                "cmdPurgeCADImport",
                "Purge CAD Imports",
                thisAssemblyPath,
                "Kipple.PurgeCADImports");

            PushButton pb1 = ribbonPanel.AddItem(b1Data) as PushButton;
            pb1.ToolTip = "Select Multiple Lines to Obtain Total Length";
            BitmapImage pb1Image = new BitmapImage(new Uri("pack://application:,,,/GrimshawRibbon;component/Resources/PurgePlus.png"));
